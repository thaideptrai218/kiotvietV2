...
public class RegistrationRequest {
    ...
    @Pattern(regexp = "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&()\\-+_=#])[A-Za-z\\d@$!%*?&()\\-+_=#]{8,}$", message = "Password must contain at least one uppercase letter, one lowercase letter, one digit, and one special character")
